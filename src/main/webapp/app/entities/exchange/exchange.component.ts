...
export class ExchangeComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.exchangeService
      ...
      .subscribe((res: HttpResponse<IExchange[]>) => this.paginateExchanges(res.body, res.headers));
  }
  ...
  trackId(index: number, item: IExchange) {
    return item.id;
  }
  ...
  protected paginateExchanges(data: IExchange[], headers: HttpHeaders) {
