...
describe('Service Tests', () => {
  describe('Rates Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Rates(0, BankName.PRB);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Rates', () => {
        const returnedFromService = Object.assign(
          {
            bankSystemName: 'BBBBBB'
          },
          elemDefault
        );
      ...
      it('should return a list of Rates', () => {
        const returnedFromService = Object.assign(
          {
            bankSystemName: 'BBBBBB'
          },
