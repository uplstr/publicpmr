...
import { TaxiComponent } from 'app/entities/taxi/taxi.component';
import { TaxiService } from 'app/entities/taxi/taxi.service';
import { Taxi } from 'app/shared/model/taxi.model';

describe('Component Tests', () => {
  describe('Taxi Management Component', () => {
    let comp: TaxiComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TaxiComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.taxis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
