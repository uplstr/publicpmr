...
public class CursResourceIT {
    ...
    private static final Integer DEFAULT_PURCHASE = 1;
    private static final Integer UPDATED_PURCHASE = 2;
    ...
    public void getAllCurs() throws Exception {
        ...
        restCursMockMvc.perform(get("/api/curs?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].purchase").value(hasItem(DEFAULT_PURCHASE)))
    ...
    public void getCurs() throws Exception {
        ...
        restCursMockMvc.perform(get("/api/curs/{id}", curs.getId()))
            ...
            .andExpect(jsonPath("$.purchase").value(DEFAULT_PURCHASE))
